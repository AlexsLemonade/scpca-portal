    ...
    "api-configuration/api-server-instance-user-data.tpl.sh",
    {
      ...
      api_environment = templatefile(
        "api-configuration/environment.tpl",
        {
          ...
          aws_batch_job_queue_name_fargate = module.batch.job_queue_name_fargate
          aws_batch_job_definition_name_fargate = module.batch.job_definition_name_fargate
          aws_batch_job_queue_name_ec2 = module.batch.job_queue_name_ec2
          aws_batch_job_definition_name_ec2 = module.batch.job_definition_name_ec2
