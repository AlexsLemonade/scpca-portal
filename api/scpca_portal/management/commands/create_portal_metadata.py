...
class Command(BaseCommand):
    ...
    def create_portal_metadata(
        self, clean_up_output_data: bool, update_s3: bool, **kwargs: Any
    ) -> None:
    ...
    def purge_computed_file(self, computed_file: ComputedFile, update_s3: bool = False) -> None:
        if update_s3:
