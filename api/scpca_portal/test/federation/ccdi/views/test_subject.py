...
ENDPOINTS = (
    "/federation/ccdi/v1/subject",
    "/federation/ccdi/v1/subject/by/sex/count",
    "/federation/ccdi/v1/subject/summary",
    "/federation/ccdi/v1/subject/alsf/scpca/SUBJECT1",
    "/federation/ccdi/v1/subject-diagnosis",
)
