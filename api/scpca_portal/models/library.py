...
class Library(TimestampedModel):
    ...
    def get_project_libraries_from_download_config(
        ...
        if download_configuration not in common.GENERATED_PROJECT_DOWNLOAD_CONFIGURATIONS.values():
    ...
    def get_sample_libraries_from_download_config(
        ...
        if download_configuration not in common.GENERATED_SAMPLE_DOWNLOAD_CONFIGURATIONS.values():
            raise ValueError("Invalid download configuration passed. Unable to retrieve libraries.")
